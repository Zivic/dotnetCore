...
public class EmployeeLinks
{
    ...
    private bool ShouldGenerateLinks(HttpContext httpContext)
    {
        ...
        //TODO: check if this works, modified
        return mediaType.MediaType.Split('+')[0].EndsWith("hateoas", StringComparison.InvariantCultureIgnoreCase);
    }
        ...
        Guid id, string fields = "")
    {
        var links = new List<Link>
        {
            ...
            new Link(_linkGenerator.GetUriByAction(httpContext,
                    "DeleteEmployeeForCompany", values: new { companyId, id }), "delete_employee", "DELETE"),
            new Link(_linkGenerator.GetUriByAction(httpContext,
                    "UpdateEmployeeForCompany", values: new { companyId, id }), "update_employee", "PUT"),
